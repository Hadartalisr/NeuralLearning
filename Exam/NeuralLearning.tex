...
\begin{equation}
    ...
    -\eta \delta^\mu \sigma'(h_{3}(x^{\mu})) s_{1}^2(x^{\mu}) 
\end{equation}

\begin{equation}
    \Delta w_{11}^{2} = -\eta \frac{\partial y(w, u|x^{\mu})}{\partial w_{11}^{2}} = -\eta \sigma'(h_{3}(x^{\mu})) w_{1}^{3} \frac{\partial \sigma(h_{2}(x^{\mu}))}{\partial w_{11}^{2}} = -\eta \sigma'(h_{3}(x^{\mu})) w_{1}^{3} \sigma'(h_{1}^{2}) s_{1}^{+} 
\end{equation}

\begin{equation}
    \Delta w_{11}^{1} = -\eta \sigma'(h_{3}(x^{\mu})) w_{1}^{3} \frac{\partial s_{1}(x^{\mu})}{\partial w_{11}} = -\eta \sigma'(h_{3}(x^{\mu})) w_{1}^{3} \sigma'(h_{2}^{1}) w_{12}^{2} \sigma'(h_{1}^{1}) x_{1} 
\end{equation}

\begin{equation}
    \frac{\partial y}{\partial w_{ij}} = \sigma'(h^{3}) w_{1}^{3} \sigma'(h^{2}) w_{12}^{2} \sigma'(h^{1}) x_{j} 
\end{equation}

\begin{equation}
    \sigma'(h^{(2)}) = \text{diag} [\sigma'(h_{i}^{(2)})] 
\end{equation}

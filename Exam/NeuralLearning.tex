...
First-Order Reduced and Controlled Error (FORCE) learning is a method that allows output errors to feedback into the network while 
keeping them small through rapid and effective weight modifications.
...
Where:
\begin{itemize}
    \item $0 \leq \lambda \leq 1$ is the discounting factor

...
\begin{definition}[Model-based methods]\ \\
...
Examples of dynamic programming algorithms include:

Detailed explanation of a dynamic programming algorithm:

\subsection{Value iteration}

\begin{algorithm}[H] 
    \SetAlgoLined
    \KwIn{MDP $(S, A, P_{s,a}(\cdot), R_s(\cdot), \gamma)$} % Remove the extra space after this line
